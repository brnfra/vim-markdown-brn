...
"                       -- Markdown  --
"-------------------------------------------------------
autocmd Filetype markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd setlocal ts=4 sw=4 
...
"html tags"
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <u <u></u><esc>3hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <s <strong></strong><esc>8hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <p <p id="" class=""></p><esc>3hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <sp <span id="" class=""></span><esc>v6hx2o<esc>p0<esc>==<esc>ki
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <i <i></i><esc>3hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <b <b></b><esc>3hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <sub <sub></sub><esc>5hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <sup <sup></sup><esc>5hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <u <u></u><esc>3hi
"Spam definition
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <abr <abbr></abbr><esc>6hi   

autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <h1 <h1></h1><esc>4hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <h2 <h2></h2><esc>4hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <h3 <h3></h3><esc>4hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <h4 <h4></h4><esc>4hi
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <h5 <h5></h5><esc>4hi
"div"
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <di <div id="" class=""></div><esc>v5hx2o<esc>p0<esc>==<esc>ki
"Ordened List
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <ol <ol type=""></ol><esc>v4hx2o<esc>p0<esc>==<esc>ki

autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <li <li></li><esc>4hi      

"UnOrdened List
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <ul <ul type=""></ul><esc>v4hx2o<esc>p0<esc>==<esc>ki
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <li <li></li><esc>4hi      

"Table
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <ta <table border="" width=""></table><esc>v7hx2o<esc>p0<esc>==<esc>k>>i
...
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap <img <img src="" alt="description_file"> 
...
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap \< &lt;
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap \> &gt;
autocmd FileType markdown,mdown,mkdn,md,mkd,mdwn,mdtxt,mdtext,text,Rmd inoremap \. &middot;
